...
type AuctionRepository interface {
	GetAuctions(ctx context.Context, auctionFilter AuctionFilter) ([]model.Auction, int, error)
	...
	GetAuctionById(ctx context.Context, auctionId uuid.UUID) (*model.Auction, error)
